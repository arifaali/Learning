    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="<?php echo base_url(); ?>index.html"><img src="<?php echo base_url(); ?>assets/images/logo.svg" alt="logo" /></a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            ?>
                    <form class="forms-sample" id="categForm" method="post" action="<?= base_url('admin/addCategory') ?>" enctype="multipart/form-data">
